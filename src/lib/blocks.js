...
export default function (vm) {
    ...
    // const sendColours = ScratchBlocks.Colours.send;


    ScratchBlocks.Blocks.send_message = {
        init: function (start, menuOptionsFn) {
            this.jsonInit({
                message0: '发消息%1',
                args0: [{
                    type: 'field_dropdown',
                    name: 'SEND_MSG',
                    category: ScratchBlocks.Categories.send,
                    options: [
                        ['A', 'A'],
                        ['B', 'B']
                    ]
    ...
    //     const json = jsonForMenuBlock('SEND_MSG', spriteMenu, motionColors, [
    //         ['111111', '111'],
    //         ['2222222', '222']
    //     ]);
    //     this.jsonInit(json);
    ...
    // };
    // ScratchBlocks.Blocks.send_thing.init = function () {
    //     const json = jsonForMenuBlock('SEND_MSG', soundsMenu, soundColors, []);
    //     this.jsonInit(json);
    // };
