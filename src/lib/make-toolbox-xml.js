...
const send = function (isStage, targetId) {
    return `
    <category name="发消息" id="send" colour="#4C97FF" secondaryColour="#3373CC">
...
const makeToolboxXML = function (isStage, targetId, categoriesXML = [],
    ...
    const sendXML = moveCategory('send') || send(isStage, targetId);
